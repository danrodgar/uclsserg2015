...
## Classical Hypothesis Testing
  ...
  - The rationale of the process is that the statistical hypothesis should be *falsifiable*, that is, we can find evidente that the hypothesis is not true. We try to find evidence against the null hypothesis in order to support our alternative hypothesis $H_A$
...
## p-values
  - p-value: the p-value of a statistical test is the probability, computed as suming that $H_0$ is true, that the test statistic would take a value as extreme or more extreme than that actually observed. 
